    ...
    float Rank)
{
    ...
    private static string Require(string value, string parameterName)
    {
        ...
        {
            throw new ArgumentException("Generation context item value cannot be empty.", parameterName);
        }
    ...
    private static string RequireSha256(string value, string parameterName)
    {
        ...
        {
            throw new ArgumentException("Generation context item content hash must be a SHA-256 hex digest.", parameterName);
        }
    ...
    private static float RequireRank(float value, string parameterName)
    {
        ...
        {
            throw new ArgumentException("Generation context item rank must be finite.", parameterName);
        }
