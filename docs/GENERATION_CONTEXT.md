...
Invalid transport parameters return `400`. Evidence invariant violations return `422` rather than constructing a partially trusted context.
...
7. prior ingestion, retrieval, citation, persistence, domain, and architecture gates remain green.
